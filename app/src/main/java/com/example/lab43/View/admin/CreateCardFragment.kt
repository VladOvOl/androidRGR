...
import com.example.lab43.databinding.FragmentAdminCreateCardBinding
...
class CreateCardFragment : Fragment() {
    private lateinit var binding: FragmentAdminCreateCardBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAdminCreateCardBinding.inflate(layoutInflater, container, false)

        viewModel.userDetails.observe(viewLifecycleOwner, Observer {
            pizza = it.pizza
            //binding.userNameTextView.text = it.pizza.name
            binding.userNameTextView.setText("Введіть назву піцци")
            //binding.userDetailsTextViewPrice.text = it.pizza.company
            binding.userDetailsTextView.setText(it.pizza.price)
            ...
            binding.userDetailsTextView.setText("Введіть склад піцци")
        ...
        binding.updateButton.setOnClickListener {
            ...
            val newPizza = Pizza(randomLong, photo, name, price, details)
            val request = createRequestBody(newPizza)
            val call = apiService.createPizza(request)
